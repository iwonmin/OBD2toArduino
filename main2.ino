...
void loop() {
  switch(state) {
    ...
    case States::MAIN:
      mainscreen();
      while(state == MAIN) {
          sendCAN(CAN_RPM); delay(50);
          receiveCAN(CAN_RPM); delay(50);
          sendCAN(CAN_COOLTEMP); delay(50);
          receiveCAN(CAN_COOLTEMP); delay(50);
          sendCAN(CAN_TORQ); delay(50);
          receiveCAN(CAN_TORQ); delay(50);
          sendCAN(CAN_SPEED); delay(50);
          receiveCAN(CAN_SPEED); delay(50);
          sendCAN(CAN_LOAD); delay(50);
          receiveCAN(CAN_LOAD); delay(50);
          sendCAN(CAN_THRO); delay(50);
          receiveCAN(CAN_THRO); delay(50);
          sendCAN(CAN_FUELRATE); delay(50);
          receiveCAN(CAN_FUELRATE); delay(50);
          if(RPM.viewcurrent()>3000 || COOLTEMP.viewcurrent()>120)  tone(1,261,500);
        }
      break;
